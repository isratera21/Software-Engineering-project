                        ...
                        <div class="container-fluid">
                            <form action="save.php" method="post" ID="schedule-form">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="datetime-local" class="form-control form-control-sm rounded-0" name="Start_datetime" ID="Start_date" required>
                                </div>
                                <div class="form-group mb-2">
...
<?php 
$schedules = $conn->query("SELECT * FROM `TIMING`");
$sched_res = [];
